...
- [ ] **UX-02**: Unify the two nested tab systems in the query workspace (route-level URL tabs vs QueryPanel's inner unpersisted tabs) so SQL is never silently lost (`query.tsx:461-515`, `QueryPanel.tsx:384-418`).
